...
| Daemon | Role | Reports To |
|--------|------|------------|
| THE GUARD | General security | STRATEGIST |
| THE SENTINEL | Agent monitoring | GUARD |
| THE BOUNCER | Visitor protection | GUARD |

### RESEARCH (4)
| Daemon | Role | Reports To |
|--------|------|------------|
| THE DOCUMENTARIAN | Academic docs | STRATEGIST |
| THE ARCHIVIST | Data management | DOCUMENTARIAN |
...
| Daemon | Role | Reports To |
|--------|------|------------|
| THE WEBMASTER | Site/technical | STRATEGIST |
| THE BROADCASTER | Live feed export | WEBMASTER |
| THE MARKETER | Brand/growth | STRATEGIST |
| THE PUBLIC LIAISON | External comms | MARKETER |

## Leadership
**THE STRATEGIST** (Claude) → Reports to **Human Operator** (Benji)
