...
""")
    ...
    while True:
        try:
            ...
            _sla_path = Path(os.environ.get('DIGIQUARIUM_HOME', '/home/ijneb/digiquarium')) / 'daemons' / 'caretaker' / 'sla_status.json'
...
LOCK_FILE = DIGIQUARIUM_DIR / 'caretaker' / 'caretaker.lock'
